...
<template>
  <div class="about-page">
    ...
    <main>
      ...
      <h1 class="animated-title">Media & Press 📽️🗞️🎬</h1>
  ...
  data() {
    return {
      aboutBullets: [
        ...
        {
          emoji: "🚀",
          text: "Started in 2022 when a team member went nuts after his museum trip. Later, we thought of ArtVista's initial for the first time."
        },
        {
          emoji: "🎡",
